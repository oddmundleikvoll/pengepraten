...
export const metadata: Metadata = {
  ...
  description: 'Norges Bank holder rentemøte 13. august 2026. Styringsrenten er 4,25 %, og markedet priser ~50 % sjanse for heving. Konkrete råd for sparepengene dine.',
  keywords: ['Norges Bank rente august 2026', 'styringsrente august 2026', 'høyrentekonto rente 2026', 'rentevedtak 13. august', 'bør jeg flytte sparepengene'],
  openGraph: {
    title: 'Norges Bank 13. august: Dette bør du gjøre med sparepengene',
    description: 'Norges Bank holder rentemøte 13. august 2026. Styringsrenten er 4,25 %, og markedet priser ~50 % sjanse for heving. Konkrete råd for sparepengene dine.',
    type: 'article',
...
const faqs = [
  {
    q: 'Når hever Norges Bank renten igjen?',
    a: 'Det finner vi ut torsdag 13. august 2026 kl. 10:00. Per nå er markedets forventning omtrent 50/50 mellom uendret (4,25 %) og heving til 4,50 %. Det endelige signalet ligger i pressekonferansen og den oppdaterte rentebanen som publiseres samme dag.',
  },
  {
    q: 'Hva skjer med høyrentekonto hvis renten går opp?',
    a: 'Høyrentekontoer følger som regel styringsrenten — men med 2–8 ukers etterslep. Hvis Norges Bank hever til 4,50 % i august, vil de fleste høyrentekontoene typisk justeres opp i løpet av september–oktober. Bankene er ikke forpliktet til å heve, men i praksis gjør de det for å holde seg konkurransedyktige. Noen aktører (spesielt mindre nettbanker) er raskere enn storbankene.',
  },
  {
    q: 'Bør jeg binde boliglånsrenta nå?',
    a: 'Sannsynligvis ikke. Å binde en fastrente i dag er å ta en beslutning på et tidspunkt der Norges Bank kan endre signalene i begge retninger. Vent til 13. august — da har du et tydeligere bilde. Hvis NB fortsetter å heve og markedet tolker det som starten på en ny opptrappingsrunde, kan det være fornuftig å vurdere fastrente for en del av lånet.',
  },
  {
    q: 'Lønner det seg å flytte sparepengene før 13. august?',
    a: 'Ja, hvis du i dag står i en storbank med lav rente. Selv om NB holder uendret, vil en høyrentekonto typisk gi deg 1,5–2,0 prosentpoeng mer i året. På 100 000 kr er det 1.500–2.000 kr før skatt. Prosessen tar 1–3 virkedager, og de aller fleste bankene tilbyr gratis kontooverføring. Det er ingen god grunn til å vente.',
  },
  {
    q: 'Hva er forskjellen på styringsrente og høyrentekonto-rente?',
  ...
  {
    q: 'Bør jeg flytte BSU nå?',
    a: 'BSU er noe helt annet — en egen ordning med 10 % skattefradrag. Hvis du har BSU i en bank med lav rente, bør du vurdere å flytte den til en bank med høy BSU-rente (for eksempel Sbanken 6,10 % eller OBOS 5,80 %). Men pass på: du kan bare ha én BSU om gangen, og overføring mellom banker tar 2–4 uker på grunn av skattemeldingen. Ikke gjør det i siste liten.',
  },
  {
    q: 'Påvirker dette forbrukslånet mitt?',
    a: 'Ja, men forbrukslån har allerede rente i sjiktet 9–15 % — en endring på 0,25 pp i styringsrenten er støy i den sammenhengen. Det viktigste du kan gjøre med forbruksgjeld er å refinansiere til billigere lån — ikke å flytte pengene.',
  },
]
    ...
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            publisher: {
              ...
              logo: {
                '@type': 'ImageObject',
                url: 'https://pengepraten.no/logo.png',
              },
            },
            mainEntityOfPage: {
              '@type': 'WebPage',
      ...
      <section className="bg-gradient-to-br from-primary-600 to-accent-700 text-white py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <nav className="text-primary-200 text-sm mb-4">
            ...
            <span className="mx-2">/</span>
            <span>Norges Bank rentevedtak august 2026</span>
          </nav>
          <div className="inline-block bg-amber-400 text-amber-900 text-xs font-bold px-3 py-1 rounded-full mb-4">
            RENTEMØTE 13. AUGUST 2026
          </div>
          <h1 className="text-3xl md:text-4xl font-black mb-4">
            Norges Bank 13. august: Dette bør du gjøre med sparepengene
          </h1>
          <p className="text-primary-100 text-lg max-w-2xl">
            Torsdag 13. august 2026 kl. 10:00 bestemmer Norges Bank om
            styringsrenten blir holdt på 4,25 % eller hevet videre. Markedet
            priser inn rundt 50 % sannsynlighet for heving. Her er hva det
            betyr for sparepengene dine — med konkrete råd.
          </p>
        </div>
      </section>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 py-12 article-content">
        ...
        <p>
          ...
          — har mange analytikere tolket signalene som «videre opptrapping,
          men ikke akkurat nå». KPI falt til 3,1 % i mai, noe som gir komiteen
        ...
        <p>
          ...
          (Sbanken, SB1-bankene, BN Bank, Sparebanken Møre m.fl.) beholder
          sine satser. Markedet puster litt.
        </p>
        ...
        <p>
          ...
          attraktivt relativt til andre spareformer. Boliglånsrentene kan
          stige 0,20–0,30 prosentpoeng i løpet av høsten.
        </p>

        <div className="bg-primary-50 border-l-4 border-primary-400 rounded-r-xl p-6 my-8">
          <p className="text-sm text-primary-900 leading-relaxed m-0">
        ...
        <p>
          Hovedregelen er enkel: <strong>Flytt pengene som står i en
          storbank-konto med 2–3 % rente, over i en høyrentekonto som gir
          4–4,65 % — før 13. august</strong>. Markedet reagerer raskt, og
          enkelte banker strammer inn på innskuddsvilkårene (antall frie
          uttak, rentetrapp) rett etter rentevedtak. Men det er forskjell på
          kort, mellomlang og lang sikt.
        </p>

        <h3>Kortsiktig sparing (1–3 måneder) — bufferkonto og BSU</h3>
        <p>
          Har du en <strong>bufferkonto i storbanken</strong> til 2,5–3,5 %?
          Da finnes det nesten ingen grunn til ikke å flytte den. Forskjellen
        ...
        <p>
          ...
          Skattefradraget på 10 % av innskuddet erstatter nesten alt annet.
          OBOS tilbyr 5,80 % og Sbanken 6,10 % nominelt — kontakt banken før
          du setter inn, fordi BSU-vilkår ofte forutsetter at du ikke har
          annen BSU fra før. Les mer i vår{' '}
          <Link href="/sparing/bsu-guide">komplette BSU-guide</Link>.
        </p>
        ...
        <p>
          ...
          rente</strong>. Du får altså betalt for å gi banken beskjed 31 dager
          før uttak. For sparing til planlagte utgifter (bil, ferie,
          egenkapital) i løpet av ett år, er dette et godt kompromiss.
        </p>

        <h3>Langtsiktig sparing (1+ år) — indeksfond og IPS</h3>
        <p>
          ...
          krever at du tåler svingninger. En tommelfinger-regel er at pengene
          bør stå i minst 5 år for å ha god sjanse for positiv realavkastning.
        </p>
        <p>
          Har du allerede maks BSU, vurder{' '}
          <strong>IPS (individuell pensjonssparing)</strong>. Fra 1. januar
          2026 fikk rentefond utsatt beskatning — først ved salg — noe som
          gjør fond i IPS-skallet mer attraktivt. IPS er spesielt gunstig
          hvis du har topp pensjonsopptjening i jobben, eller er selvstendig
          næringsdrivende.
        </p>
        ...
        <ul>
          <li>
            ...
            Selv et hevingsvedtak på 0,25 pp betyr bare marginalt høyere rente
            i bankene — og du rekker uansett å flytte etterpå.
          </li>
          <li>
        ...
        <p>
          ...
          <Link href="/sparing/hoyrentekonto">
          ...
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="bg-primary-50">
                ...
                <th className="text-left p-3 border border-gray-200 font-semibold">Uttak</th>
            ...
            <tbody>
              <tr className="bg-white">
                ...
                <td className="p-3 border border-gray-200">Ubegrenset</td>
                <td className="p-3 border border-gray-200">
                  <a
                    href="https://www.svea.com/nb-no/privat/sparing"
                    target="_blank"
              ...
              <tr className="bg-gray-50">
                ...
                <td className="p-3 border border-gray-200">Ingen</td>
                <td className="p-3 border border-gray-200">24 gebyrfrie/år</td>
                <td className="p-3 border border-gray-200">
                  <a
                    href="https://www.obos.no/bank/sparing"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    obos.no
              ...
              <tr className="bg-white">
                ...
                <td className="p-3 border border-gray-200 font-bold">4,50 %</td>
                <td className="p-3 border border-gray-200">Ingen</td>
                <td className="p-3 border border-gray-200">Fritt uttak</td>
                <td className="p-3 border border-gray-200">
                  <a
                    href="https://www.nordax.no/spare"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    nordax.no
              ...
              <tr className="bg-gray-50">
                ...
                <td className="p-3 border border-gray-200 font-bold">4,49 %</td>
                <td className="p-3 border border-gray-200">Begrenset</td>
                <td className="p-3 border border-gray-200">Månedlig kapitalisering</td>
                <td className="p-3 border border-gray-200">
                  <a
                    href="https://www.bnbank.no/sparing/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    bnbank.no
              ...
              <tr className="bg-white">
                ...
                <td className="p-3 border border-gray-200">Sparekonto fordel (LO/Akademikerne)</td>
                <td className="p-3 border border-gray-200 font-bold">4,45 %</td>
                <td className="p-3 border border-gray-200">Ingen</td>
                <td className="p-3 border border-gray-200">12 frie uttak/år</td>
                <td className="p-3 border border-gray-200">
                  <a
                    href="https://www.handelsbanken.no/no/forening/tekna"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    handelsbanken.no
              ...
              <tr className="bg-gray-50">
                ...
                <td className="p-3 border border-gray-200">Sparekonto</td>
                <td className="p-3 border border-gray-200 font-bold">4,40 %</td>
                <td className="p-3 border border-gray-200">Ingen</td>
                <td className="p-3 border border-gray-200">Fritt uttak</td>
                <td className="p-3 border border-gray-200">
                  <a
                    href="https://morrowbank.no/sparing/hvordan-fungerer-sparekonto"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    morrowbank.no
              ...
              <tr className="bg-white">
                ...
                <td className="p-3 border border-gray-200 font-bold">4,40 %</td>
                <td className="p-3 border border-gray-200">Ingen</td>
                <td className="p-3 border border-gray-200">4 frie uttak/år</td>
                <td className="p-3 border border-gray-200">
                  <a
                    href="https://www.storebrand.no/privat/bank-og-lan/hoyrentekonto"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    storebrand.no
        ...
        <ul>
          <li>
            <strong>Svea Bank og Morrow Bank</strong> er utenlandske (svenske)
            nettbanker, men lovlige for norske kunder. Garantien er den
            svenske innskuddsgarantien (100 000 EUR), pluss det norske
            sikringsfondet for innskudd opp til 2 millioner kroner så lenge
            banken har norsk filial/tillatelse.
          </li>
          <li>
            <strong>Handelsbanken Sparekonto fordel</strong> krever medlemskap
            i LO, Akademikerne, Tekna, Legeforeningen eller AFAG. Uten dette
            får du Sparekonto Pluss (4,25 % fra 100k).
          </li>
          <li>
            <strong>Storebrand</strong> gir 4,40 % kun på beløp over 500 000
            kr. Under denne terskelen er satsen lavere.
          </li>
          <li>
        ...
        <ol>
          ...
          <li>
            ...
            hever, kan det faktisk argumenteres for å binde — men da har du en
            tydeligere grunn til å handle.
          </li>
          <li>
        ...
        <p>
          Vi har en{' '}
          <Link href="/boliglan/boliglan-rente-2026">
            komplett oversikt over boliglånsrenter 2026
          </Link>{' '}
          og en{' '}
          <Link href="/artikler/norges-bank-hever-renten-mai-2026">
        ...
        <div className="space-y-4 not-prose">
          {faqs.map((faq, i) => (
            ...
            >
              <summary className="flex items-center justify-between gap-4 px-6 py-5 cursor-pointer font-bold text-gray-800 hover:text-primary-600 transition-colors list-none">
        ...
        <p>
          ...
          kontoer som har blitt mer eller mindre attraktive.
        </p>
        ...
        <div className="bg-gray-50 rounded-xl p-6 mt-8">
          ...
          <ul className="space-y-2 text-sm">
            <li>
              ...
              >
                Komplett oversikt over høyrentekontoer 2026 →
              </Link>
            </li>
            <li>
              <Link
                href="/sparing/bsu-guide"
                className="text-primary-600 hover:underline font-medium"
              >
                BSU-guide 2026 →
              </Link>
            ...
            <li>
              <Link
                href="/boliglan/boliglan-rente-2026"
                className="text-primary-600 hover:underline font-medium"
              >
                Komplett oversikt over boliglånsrenter 2026 →
              </Link>
            ...
            <li>
              <Link
                href="/artikler/norges-bank-hever-renten-mai-2026"
                className="text-primary-600 hover:underline font-medium"
              >
        ...
        <div className="bg-amber-50 border-l-4 border-amber-400 rounded-r-xl p-6 mt-8">
          ...
          <p className="text-sm text-gray-700 leading-relaxed">
            ...
            den effektive renten hos banken før du signerer låneavtaler.
