...
import { BarChart3, Check, X, PiggyBank } from 'lucide-react'
  ...
  return (
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 py-12 article-content space-y-8">
        ...
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
            <BarChart3 className="w-5 h-5" /> Sammenligningstabell
          </h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
            <span></span> Fordeler og ulemper med budsjettapper
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-green-50 rounded-xl p-6 border border-green-200">
              <h3 className="font-bold text-green-800 mb-4 flex items-center gap-2">
                <Check className="w-5 h-5 text-green-600" /> Fordeler
              </h3>
            ...
            <div className="bg-red-50 rounded-xl p-6 border border-red-200">
              <h3 className="font-bold text-red-800 mb-4 flex items-center gap-2">
                <X className="w-5 h-5 text-red-500" /> Ulemper
              </h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-2 text-gray-700">
