      ...
      <section className="bg-paper text-ink py-16 border-b border-border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <nav className="font-mono text-xs uppercase tracking-wider text-ink-muted mb-6">
            ...
            <span className="text-ink">Budsjett</span>
          </nav>
          <h1 className="text-3xl md:text-5xl font-medium font-display leading-[1.08] mb-4">Budsjett</h1>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <ul className="space-y-3 mb-8">
              {[
                ...
                <li key={item} className="flex items-center gap-3">
                  <div className="w-5 h-5 rounded-full bg-amber-warm-soft flex items-center justify-center flex-shrink-0">
                    <svg className="w-3 h-3 text-amber-warm" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-paper-alt rounded-xl p-6 mb-8 border border-border">
            ...
            <div className="bg-amber-warm-soft rounded-xl p-6 mb-8 border border-amber-warm/20">
              <h3 className="font-bold text-ink mb-2">Hvordan fungerer det?</h3>
            ...
            <div className="grid gap-4">
              <Link href="/budsjett/kom-i-gang-med-budsjett" className="group">
                <article className="bg-paper-surface rounded-xl border border-border shadow-sm hover:shadow-md hover:border-amber-warm/40 transition-all duration-200 overflow-hidden">
                  <div className="px-5 pt-5 pb-0">
                    <span className="inline-block px-3 py-1 text-xs font-medium bg-amber-warm-soft text-amber-warm rounded-full">
                      Budsjett
                    </span>
                  </div>
                  <div className="p-5">
                    <h3 className="font-semibold text-ink group-hover:text-amber-warm transition-colors mb-2">
                      Kom i gang med budsjett: En komplett guide for nordmenn
                    </h3>
                    <p className="text-sm text-ink-subtle line-clamp-3">
                    ...
                    <div className="mt-4 flex items-center text-sm text-amber-warm font-medium">
                      <span>Les mer</span>
